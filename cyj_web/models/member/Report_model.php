...
class Report_model extends MY_Model {
    ...
    public function report_data_fc($map =array()){
        ...
        $data = $this->M($db_model)
            ->field("username,sum(num) as num,sum(bet_all) as bet_all,sum(bet_yx) as bet_yx,sum(win) as win")
            ->where($map)->find();
        return $data;
    }
    ...
    public function report_data_sp($map =array()){
        ...
        $data = $this->M($db_model)
            ->field("uid,username,sum(num) as num,sum(bet_all) as bet_all,sum(bet_yx) as bet_yx,sum(win) as win")
            ->where($map)->find();
        return $data;
    }
    ...
    public function report_data_vd($map =array()){
        ...
        $ddata = $this->M($db_model)
            ->field("site_id,username,sum(num) as num,sum(bet_all) as bet_all,sum(bet_yx) as bet_yx,sum(win) as win")
