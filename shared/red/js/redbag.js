...
function red_bag_html_(red_site_domain,pic,skin){
    ...
    red_bag_html+="                    <div onclick=\"document.getElementById('hdddddddddd').style.display='none';\" style='position:absolute;z-index:900;background-repeat: no-repeat;width: 41px;height: 40px;left: 180px;background-image:url(\"../../shared/aoyun/images/close-btn.png\");zoom: 0.5;'></div>";
