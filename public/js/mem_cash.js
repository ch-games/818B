...
jQuery.validator.addMethod("chenckqq", function(value, element) {
    ...
    $.validator.addMethod('ajaxCheckData', function (value, element) {
        ...
        $.ajax({
            'url': '../register_ajax/user_ajax_check',
            'type': 'get',
            'data': data[id],
            'cache': false,
            'timeout': 30000,
    ...
    var validator = $("#myFORM").validate({
        ...
        'messages': {
            ...
            'mobile': { 'required': $._BuildPrompt('mobile', '✖ 请输入手机号!!', { 'width': 120}),
						'chenckmobile': $._BuildPrompt('mobile', '✖ 只能输入+开头的国际号码,或6至13位数字的正确手机号！',{ 'width': 300 }),
						'chenckChinaMobile': $._BuildPrompt('mobile', '✖ 只能输入11位的中国手机号！！',{ 'width': 200 })
            },
            'email': { 'required': $._BuildPrompt('email', '✖ 请输入邮箱!!', { 'width': 120}),
						'email':$._BuildPrompt('email', '✖ 请输入一个正确的邮箱！！',{ 'width': 160 })
            },
