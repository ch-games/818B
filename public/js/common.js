...
f_com.BBinGetPager = function(mo) {
    //視窗寬度ub連覽器判斷
    var wi ;
    if (typeof(bbpage) == 'object'){
        wi = 1012;
    }else {
        wi = 1000;
    }

    window.open("/cl/?module=" + mo, "bb", "top=50,left=50,width=" + wi + ",height=600,status=no,scrollbars=no,resizable=yes").focus();
};
...
f_com.OpenLink = function(urllink) {
    ...
    window.open(urllink , 'outPage', "top=50,left=50,width=" + wi + ",height=610,status=no,scrollbars=yes,resizable=yes").focus();
};
...
f_com.BBinEnterPager = function(mo,me,ty) {
    ...
    if (!ty){
        window.open("/cl/?module=" + mo +"&PageItem=" + me , "BBinPage", "top=50,left=50,width=" + wi + ",height=600,status=no,scrollbars=no,resizable=yes").focus();
    }else{
        window.open("/cl/?module=" + mo +"&PageItem=" + me+"&type=" + ty , "BBinPage", "top=50,left=50,width=" + wi + ",height=600,status=no,scrollbars=no,resizable=yes").focus();
    }
};
